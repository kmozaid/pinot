...
public class KafkaDatahubAvroDeserializer {
  ...
  private String resolveSecureProp(final String secret, final String secretEnvVar) {
    if (StringUtils.isBlank(secret)) {
      return System.getenv(secretEnvVar);
    }
    return secret;
  }
